...
import { RecipientSelectionSheet } from './RecipientSelectionSheet';
        ...
        >
          <RecipientSelectionSheet
            onRecipientSelect={(recipient) => {
              ...
              // Store recipient data in sessionStorage for calculator to pick up
              if (typeof window !== 'undefined') {
                window.sessionStorage.setItem('selectedRecipient', JSON.stringify(recipient));
              }
              // Use Next.js navigation to avoid flash
              if (onNavigateTo) {
                onNavigateTo('/prototypes/sendmoney/calculator');
              }
            }}
          />
        </BottomSheet>
